...
test/CMakeFiles/pick_ur5.dir/pick_ur5.cpp.o: /root/ws_moveit/src/moveit_task_constructor/core/test/pick_ur5.cpp
test/CMakeFiles/pick_ur5.dir/pick_ur5.cpp.o: test/CMakeFiles/pick_ur5.dir/compiler_depend.ts
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --green --progress-dir=/root/ws_moveit/build/moveit_task_constructor_core/CMakeFiles --progress-num=$(CMAKE_PROGRESS_1) "Building CXX object test/CMakeFiles/pick_ur5.dir/pick_ur5.cpp.o"
...
test/CMakeFiles/pick_ur5.dir/pick_ur5.cpp.i: cmake_force
	...
	cd /root/ws_moveit/build/moveit_task_constructor_core/test && /usr/bin/c++ $(CXX_DEFINES) $(CXX_INCLUDES) $(CXX_FLAGS) -E /root/ws_moveit/src/moveit_task_constructor/core/test/pick_ur5.cpp > CMakeFiles/pick_ur5.dir/pick_ur5.cpp.i
...
test/CMakeFiles/pick_ur5.dir/pick_ur5.cpp.s: cmake_force
	...
	cd /root/ws_moveit/build/moveit_task_constructor_core/test && /usr/bin/c++ $(CXX_DEFINES) $(CXX_INCLUDES) $(CXX_FLAGS) -S /root/ws_moveit/src/moveit_task_constructor/core/test/pick_ur5.cpp -o CMakeFiles/pick_ur5.dir/pick_ur5.cpp.s
...
test/pick_ur5: /root/ws_moveit/install/rviz_marker_tools/lib/librviz_marker_tools.so
test/pick_ur5: /root/ws_moveit/install/moveit_ros_planning_interface/lib/libmoveit_move_group_interface.so.2.5.9
test/pick_ur5: /root/ws_moveit/install/moveit_ros_planning_interface/lib/libmoveit_common_planning_interface_objects.so.2.5.9
test/pick_ur5: /root/ws_moveit/install/moveit_ros_planning_interface/lib/libmoveit_planning_scene_interface.so.2.5.9
test/pick_ur5: /root/ws_moveit/install/moveit_ros_move_group/lib/libmoveit_move_group_default_capabilities.so.2.5.9
test/pick_ur5: /root/ws_moveit/install/moveit_ros_move_group/lib/libmoveit_move_group_capabilities_base.so.2.5.9
...
test/pick_ur5: /root/ws_moveit/install/moveit_ros_warehouse/lib/libmoveit_warehouse.so.2.5.9
test/pick_ur5: /root/ws_moveit/install/moveit_ros_planning/lib/libmoveit_constraint_sampler_manager_loader.so.2.5.9
test/pick_ur5: /root/ws_moveit/install/moveit_ros_planning/lib/libmoveit_plan_execution.so.2.5.9
test/pick_ur5: /root/ws_moveit/install/moveit_ros_planning/lib/libmoveit_default_planning_request_adapter_plugins.so.2.5.9
test/pick_ur5: /root/ws_moveit/install/moveit_ros_planning/lib/libmoveit_cpp.so.2.5.9
test/pick_ur5: /root/ws_moveit/install/moveit_ros_planning/lib/libmoveit_planning_pipeline.so.2.5.9
test/pick_ur5: /root/ws_moveit/install/moveit_ros_planning/lib/libmoveit_trajectory_execution_manager.so.2.5.9
test/pick_ur5: /root/ws_moveit/install/moveit_ros_planning/lib/libmoveit_planning_scene_monitor.so.2.5.9
test/pick_ur5: /root/ws_moveit/install/moveit_ros_planning/lib/libmoveit_robot_model_loader.so.2.5.9
test/pick_ur5: /root/ws_moveit/install/moveit_ros_planning/lib/libmoveit_kinematics_plugin_loader.so.2.5.9
test/pick_ur5: /root/ws_moveit/install/moveit_ros_planning/lib/libmoveit_rdf_loader.so.2.5.9
test/pick_ur5: /root/ws_moveit/install/moveit_ros_planning/lib/libmoveit_collision_plugin_loader.so.2.5.9
test/pick_ur5: /root/ws_moveit/install/moveit_ros_occupancy_map_monitor/lib/libmoveit_ros_occupancy_map_monitor.so.2.5.9
test/pick_ur5: /root/ws_moveit/install/moveit_core/lib/libcollision_detector_bullet_plugin.so.2.5.9
test/pick_ur5: /root/ws_moveit/install/moveit_core/lib/libmoveit_butterworth_filter.so.2.5.9
...
test/pick_ur5: /root/ws_moveit/install/moveit_core/lib/libmoveit_collision_distance_field.so.2.5.9
test/pick_ur5: /root/ws_moveit/install/moveit_core/lib/libmoveit_collision_detection_bullet.so.2.5.9
...
test/pick_ur5: /root/ws_moveit/install/moveit_core/lib/libmoveit_dynamics_solver.so.2.5.9
test/pick_ur5: /opt/ros/humble/lib/libkdl_parser.so
test/pick_ur5: /root/ws_moveit/install/moveit_core/lib/libmoveit_constraint_samplers.so.2.5.9
test/pick_ur5: /root/ws_moveit/install/moveit_core/lib/libmoveit_distance_field.so.2.5.9
test/pick_ur5: /root/ws_moveit/install/moveit_core/lib/libmoveit_kinematics_metrics.so.2.5.9
test/pick_ur5: /root/ws_moveit/install/moveit_core/lib/libmoveit_planning_interface.so.2.5.9
test/pick_ur5: /root/ws_moveit/install/moveit_core/lib/libmoveit_planning_request_adapter.so.2.5.9
test/pick_ur5: /root/ws_moveit/install/moveit_core/lib/libmoveit_planning_scene.so.2.5.9
test/pick_ur5: /root/ws_moveit/install/moveit_core/lib/libmoveit_kinematic_constraints.so.2.5.9
test/pick_ur5: /root/ws_moveit/install/moveit_core/lib/libmoveit_collision_detection_fcl.so.2.5.9
test/pick_ur5: /root/ws_moveit/install/moveit_core/lib/libmoveit_collision_detection.so.2.5.9
test/pick_ur5: /root/ws_moveit/install/moveit_core/lib/libmoveit_smoothing_base.so.2.5.9
test/pick_ur5: /root/ws_moveit/install/moveit_core/lib/libmoveit_test_utils.so.2.5.9
test/pick_ur5: /root/ws_moveit/install/moveit_core/lib/libmoveit_trajectory_processing.so.2.5.9
test/pick_ur5: /root/ws_moveit/install/moveit_core/lib/libmoveit_robot_trajectory.so.2.5.9
test/pick_ur5: /root/ws_moveit/install/moveit_core/lib/libmoveit_robot_state.so.2.5.9
test/pick_ur5: /root/ws_moveit/install/moveit_core/lib/libmoveit_robot_model.so.2.5.9
test/pick_ur5: /root/ws_moveit/install/moveit_core/lib/libmoveit_exceptions.so.2.5.9
test/pick_ur5: /root/ws_moveit/install/moveit_core/lib/libmoveit_kinematics_base.so
test/pick_ur5: /root/ws_moveit/install/srdfdom/lib/libsrdfdom.so.2.0.8
test/pick_ur5: /opt/ros/humble/lib/liburdf.so
test/pick_ur5: /opt/ros/humble/lib/x86_64-linux-gnu/libruckig.so
test/pick_ur5: /root/ws_moveit/install/moveit_core/lib/libmoveit_transforms.so.2.5.9
...
test/pick_ur5: /root/ws_moveit/install/moveit_core/lib/libmoveit_utils.so.2.5.9
...
test/pick_ur5: /root/ws_moveit/install/moveit_task_constructor_msgs/lib/libmoveit_task_constructor_msgs__rosidl_typesupport_fastrtps_c.so
...
test/pick_ur5: /root/ws_moveit/install/moveit_task_constructor_msgs/lib/libmoveit_task_constructor_msgs__rosidl_typesupport_fastrtps_cpp.so
...
test/pick_ur5: /root/ws_moveit/install/moveit_task_constructor_msgs/lib/libmoveit_task_constructor_msgs__rosidl_typesupport_introspection_c.so
...
test/pick_ur5: /root/ws_moveit/install/moveit_task_constructor_msgs/lib/libmoveit_task_constructor_msgs__rosidl_typesupport_introspection_cpp.so
...
test/pick_ur5: /root/ws_moveit/install/moveit_task_constructor_msgs/lib/libmoveit_task_constructor_msgs__rosidl_typesupport_cpp.so
...
test/pick_ur5: /root/ws_moveit/install/moveit_task_constructor_msgs/lib/libmoveit_task_constructor_msgs__rosidl_generator_py.so
test/pick_ur5: /root/ws_moveit/install/moveit_task_constructor_msgs/lib/libmoveit_task_constructor_msgs__rosidl_typesupport_c.so
test/pick_ur5: /root/ws_moveit/install/moveit_task_constructor_msgs/lib/libmoveit_task_constructor_msgs__rosidl_generator_c.so
...
test/pick_ur5: test/CMakeFiles/pick_ur5.dir/link.txt
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --green --bold --progress-dir=/root/ws_moveit/build/moveit_task_constructor_core/CMakeFiles --progress-num=$(CMAKE_PROGRESS_2) "Linking CXX executable pick_ur5"
	cd /root/ws_moveit/build/moveit_task_constructor_core/test && $(CMAKE_COMMAND) -E cmake_link_script CMakeFiles/pick_ur5.dir/link.txt --verbose=$(VERBOSE)
...
test/CMakeFiles/pick_ur5.dir/clean:
	cd /root/ws_moveit/build/moveit_task_constructor_core/test && $(CMAKE_COMMAND) -P CMakeFiles/pick_ur5.dir/cmake_clean.cmake
.PHONY : test/CMakeFiles/pick_ur5.dir/clean

test/CMakeFiles/pick_ur5.dir/depend:
	cd /root/ws_moveit/build/moveit_task_constructor_core && $(CMAKE_COMMAND) -E cmake_depends "Unix Makefiles" /root/ws_moveit/src/moveit_task_constructor/core /root/ws_moveit/src/moveit_task_constructor/core/test /root/ws_moveit/build/moveit_task_constructor_core /root/ws_moveit/build/moveit_task_constructor_core/test /root/ws_moveit/build/moveit_task_constructor_core/test/CMakeFiles/pick_ur5.dir/DependInfo.cmake --color=$(COLOR)
